...
*Add functionality for users that for get password, assigning temporary 
	link for user toselect after getting link in the email they registered with
...
*check that sessions work and make sure secure pages redirect users to login or register pages
*addslashes necessary for usernames and passwords?
